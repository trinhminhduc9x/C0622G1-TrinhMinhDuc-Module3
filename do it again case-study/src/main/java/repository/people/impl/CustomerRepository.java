...
public class CustomerRepository implements ICustomerRepository {
    ...
    private final String ADD_CUSTOMER = "INSERT INTO customer (customer_type_id,customer_name,date_of_birth,gender,id_card,phone_number,email,address) VALUE (?,?,?,?,?,?,?,?)";
    private final String FIND_BY_ID = "select * from customer where customer_id = ?";
    private final String UPDATE_CUSTOMER = "update customer set customer_type_id =?,customer_name =?,date_of_birth =?,gender = ?,id_card =?,phone_number=?, email = ?,address =?,where customer_id = ?;";
    private final String DELETE_BY_ID ="delete from customer where customer_id=?";
    private final String SEARCH_CUSTOMER = "select * from customer where customer_name like ? and phone_number like ? ,and email like ? and customer_type_id like ?";
