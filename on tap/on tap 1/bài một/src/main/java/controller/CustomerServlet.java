...
public class CustomerServlet extends HttpServlet {
    ...
    private void updateCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name = request.getParameter("name");
        String founding =request.getParameter("dayOfBirth");
        int number = Integer.parseInt(request.getParameter("idCard"));
    ...
    private void addCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int number = Integer.parseInt(request.getParameter("idCard"));
        String address=request.getParameter("address");
        Customer customer = new Customer(customerTypeId,name,number,founding,address);
        Map<String,String>errorList=customerService.checkValidateCustomer(customer);
        if (errorList.isEmpty()) {
