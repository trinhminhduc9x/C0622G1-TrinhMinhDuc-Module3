    ...
    <form class="w-50 text-warning fw-bold shadow-lg p-5 bg-light" action="/Customer?action=updateCustomer" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <select class="border-warning border-3 rounded-3 form-select-md" name="customerType"
                        ...
                        <c:forEach var="customerType" items="${customerTypeList}">
                            <c:if test="${customer.idMember==customerType.idMember}">
                                <option value="${customerType.idMember}">${customerType.nameMember}</option>
                            </c:if>
                        </c:forEach>
                ...
                <div class="mb-3">
                    <label for="birthday" class="form-label">Select founding</label>
                    <input type="date" class="form-control" name="dayOfBirth" value="${customer.founding}"
                           id="birthday">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="idCard" class="form-label">Enter number</label>
                    <input type="text" class="form-control" placeholder="Enter customer Id Card" id="idCard"
                           value="${customer.number}" name="idCard">
